...
%     end
% end
% figure('NumberTitle','Off','Name','Magnitude of Gabor Filter');
% imshow(abs(gaborArray{3,6}),[]);
% 
% figure('NumberTitle','Off','Name','Real Part of Gabor Filter');
% imshow(real(gaborArray{3,6}),[]);
toc
end